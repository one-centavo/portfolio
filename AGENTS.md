...
- `docker compose exec app pnpm run build` - Compile for production
...
- **Color Palette (Tailwind CSS)**:
  ...
  - Borders: `#262931` (thin card borders)
  - Accent / Neon: `#a3e635` (lime green for hover states, buttons, glow, status)
  - Text Primary: `#ededed`
  - Text Secondary: `#8a8f9d`
- **Component Style**:
  - Always use thin borders (`border border-[#262931]`) for cards.
  - Interactive elements should have a subtle lime green hover state (`hover:border-[#a3e635]/50`).
